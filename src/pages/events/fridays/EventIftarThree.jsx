...
const EventIftarThree = () => {
  const eventData = {
    ...
    date: "22 رمضان 1446",
    description:
      "تميزت الجمعة الثالثة ببرنامج خاص للأطفال يتضمن أنشطة ترفيهية وتعليمية عن قيم رمضان، بالإضافة إلى توزيع هدايا وألعاب تعليمية. كما تم تقديم وجبات إفطار صحية ومتوازنة.",
    images: [
