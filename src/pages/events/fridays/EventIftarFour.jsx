...
const EventIftarFour = () => {
  const eventData = {
    title: "جمعة الخير الرابعة",
    date: "29 رمضان 1446",
    description:
      "اختتمت فعاليات جمعة الخير في رمضان بحفل ختامي كبير شهد توزيع الهدايا على المتطوعين والمشاركين، وتكريم الجهات الداعمة. كما تم الإعلان عن استمرار المبادرة في الأعوام القادمة.",
    images: [
