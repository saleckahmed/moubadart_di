...
const EventIftarTwo = () => {
  const eventData = {
    ...
    date: "15 رمضان 1446",
    description: "شهدت الجمعة الثانية استمراراً لفعاليات الإفطار الجماعي مع إضافة برنامج توعوي عن أهمية الصحة الغذائية في رمضان. تم توزيع أكثر من 300 وجبة إفطار مع حقيبة تحتوي على مواد توعوية.",
    images: [
